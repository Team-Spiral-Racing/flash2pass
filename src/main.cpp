 ...
 *
 * Wiring:
 * - Relay: GPIO 5 -> Relay signal pin, GND -> Relay DC-, 5V -> Relay DC+
 * - Button: GPIO 4 -> Button -> GND (uses internal pull-up)
 *
 * Behavior:
 * 1. Press button: Relay activates for 2 seconds
 * 2. Press during activation: Cancel activation
 * 3. Hold button: Relay continuously activates while held
 */
#include <Arduino.h>
